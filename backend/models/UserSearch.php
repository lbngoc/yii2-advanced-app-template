...
class UserSearch extends User
{
    ...
    public function search($params)
    {
        ...
        if (!empty($this->create_time)) {
            $query->andFilterWhere(['like', "{$userTable}.create_time",
                Yii::$app->formatter->asDate($this->create_time, 'yyyy-MM-dd')]);
        }

        if (!empty($this->update_time)) {
            $query->andFilterWhere(['like', "{$userTable}.update_time",
                Yii::$app->formatter->asDate($this->update_time, 'yyyy-MM-dd')]);
        }
